				...
				try {
						...
						String str = " class Hash"
								...
								+ "Vagrant.configure('2') do |config|"
								  ...
								  + "config.vm.provider :aws do |aws, override|"
								    + "aws.access_key_id = 'AKIAJMMIUQW6UCP2HPEQ'"
								    + "aws.secret_access_key = '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'"
								    + "aws.security_groups = ['aldo']"
								    + "aws.keypair_name = 'aldohenriqueunb1'"
								    + "aws.instance_type='t2.2xlarge'"
								    + "aws.ami = 'ami-049fe7573cec0ed0f'"
								    + "aws.region = 'us-east-1'"
								    + "override.ssh.username = 'ubuntu'"
								    + "override.ssh.private_key_path = 'aldohenriqueunb1.pem'"
								  + "end"
								+ "end";
					...
					if (providerCloud == 3) {
						...
						String str = "class Hash\n"
								...
								+ "\n"
								+ "config.vm.provider :aws do |aws, override|\n"
								+ "  aws.access_key_id = \"AKIATXHR3UOM57HLLLON\" \n"
								+ "  aws.secret_access_key = \"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\"\n"
								+ "  aws.security_groups = ['aldo']\n"
								+ "  aws.keypair_name = \"aldohenrique\" \n"
								+ "  aws.instance_type=\""+mvAws+"\"\n"
								+ "  aws.ami = \"ami-0ee1d85c43b2274cc\" \n"
								+ "  aws.region = \"us-east-1\" \n"
								+ "  override.ssh.username = \"ubuntu\" \n"
								+ "  override.ssh.private_key_path = \"aldohenrique.pem\"\n"
								+ "\n"
								+ "end\n"
								+ "end";
						...
						/*String str = "Vagrant.configure(\"2\") do |config|\n"
								...
								+ "    google.google_json_key_location = \"/home/aldohenrique/Dropbox/Area de Trabalho/Minhas Aulas/UnB/Doutorado/pesquisa/Comparações/aldo/aldo.json\"\n"
								+ "    override.ssh.username = \"vagrant\"\n"
								+ "    override.ssh.private_key_path = \"/home/aldohenrique/Dropbox/Area de Trabalho/Minhas Aulas/UnB/Doutorado/pesquisa/Comparações/aldo/aldo\"\n"
								+ "  end\n"
								+ "\n"
								+ "end";*/
					...
					if (providerCloud == 4) {
						...
						String str = " Vagrant.configure('2') do |config|\n"
								...
								+ "    az.tenant_id = 'ec359ba1-630b-4d2b-b833-c8e6d48f8059'\n"
								+ "    az.client_id = 'aaf1f0ea-1853-4699-aa65-52f5d829e1d0'\n"
								+ "    az.client_secret = '2w90fST.mb42DbR59qWLnGIJTekv-DL05f'\n"
								+ "    az.subscription_id = '93c5e495-fadb-4cf7-8c97-446076182434'\n"
								...
								+ "    #az.resource_group_name = \"masaopenmp2\"\n"
								+ "    az.location = 'eastus'\n"
								+ "    az.vm_vhd_uri = 'https://masaopenmp.blob.core.windows.net/masaopenmo/frosty-pond-43_disk1_d4bde1633c084341960eaa8245de10b2.vhd'\n"
